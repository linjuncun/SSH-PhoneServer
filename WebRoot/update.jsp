...
<body>
	<div id="container"> 
		...
		<form action="user_update.action" method="post" onsubmit="return validUP();">
			<input type="hidden" value="${id}" name="id">
			<div>
			   <ul>
			     <li>
			        <p><input id="input1" type="text" name="phoneName" value="${ phoneName}" placeholder="请输入联系人姓名"></p>
			     </li>
			     <li>
			      <p><input id="input2" type="text" name="phoneNumber" value="${ phoneNumber}" placeholder="请输入联系人号码"></p>
			     </li>
			     <li>
			       <input style="background-color: yellow;" type="submit" name="sub1" value="保存" ><br>
			       <input style="background-color: blue;" type="reset" value="重置" >
			     </li>
			   </ul>
