		...
		<div id="morePage" data-role="page">
			...
			<!-- /header -->
				<div data-role="content">
					<div>
						<label>仅wifi下下载随时通小助手 <input 
							checked="true" type="checkbox" id="cbShowPicOnlyWifi" class="custom"> </label>
					</div>
					<div >
						<label>接收推送消息 <input 
							checked="true" type="checkbox" id="cbAcceptPush" class="custom">
						</label>
					</div>
					<ul data-role="listview" data-inset="true">
						<li  id="liCheckUpdate"><a
							>检查更新 <i
								style="font-size:0.8em; font-weight: bold; ">当前版本号： <i
									id="version"></i>
							</i>
						</a></li>
					</ul>
