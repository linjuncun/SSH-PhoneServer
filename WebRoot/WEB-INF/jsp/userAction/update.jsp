...
<html>
    ...
    <body>
        <form action="user_update.action" method="post" onsubmit="return valid()">
         <div class="success">
             <input type="hidden" value="${id}" name="id">
            <div class="select_1">
	              <table>
	                <tr>
	                 <td>联系人姓名 :</td><td><input id="input1" type="text" name="phoneName" value="${ phoneName}"></td>
	                </tr>
	                <tr>
	                <td>联系人电话 :</td><td><input id="input2" type="text" name="phoneNumber" value="${ phoneNumber}"></td>
	                </tr>
	                <tr align="center">
